...
import com.example.mobinogi.filter.JwtAuthenticationFilter;
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
		http
			...
			.authorizeHttpRequests(auth -> auth
				...
				.requestMatchers("/api/items/**", "/api/barter/**", "/api/craft/**", "/api/guild/**", "/api/monsters/**", "/api/user/**", "/api/board/**", "/api/photo-board/**", "/api/events/**").permitAll()
				// 인증 관련 API는 모든 접근 허용
