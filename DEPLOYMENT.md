...
- `DEPLOY_PATH`: server path containing `docker-compose.yml`
...
3. SSH to server, then run `docker compose -f docker-compose.yml pull app` and `docker compose -f docker-compose.yml up -d app nginx`
